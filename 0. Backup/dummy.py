...
total_discussion_body = soup.find('tbody', class_="topic-list-body")
discussions = total_discussion_body.find_all('tr', class_='topic-topic-list-item category-proposal-discussion closed ember-view-item')

formatted_html = total_discussion_body.prettify()

with open('formatted_html.txt', 'w', encoding='utf-8') as file:
...
# browser.quit()
sheet.parent.save("data.xlsx", encoding="utf-8")
